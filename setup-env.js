...
console.log(
  '3. Replace "your-ngrok-url" with your actual ngrok URL if using ngrok'
);
...
console.log("\n🔧 Additional Notes:");
console.log(
  "- For ngrok: Use the setup-ngrok.js script to automatically configure"
);
console.log(
  "- For server deployment: Make sure your backend is running on the server"
);
console.log(
  "- For localhost: Make sure both frontend and backend are running locally"
);
