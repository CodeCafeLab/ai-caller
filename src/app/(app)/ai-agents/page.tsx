                  ...
                  paginatedAgents.map((agent) => (
                    <TableRow key={agent.id}>
                      <TableCell className="font-medium">
                        <Link
                          href={`/ai-agents/create/details/${agent.id}`}
      ...
      {viewModalOpen && viewAgent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full p-6 relative">
            ...
            <div className="mb-2">
              <b>Name:</b> {viewAgent.name}
            </div>
            <div className="mb-2">
              <b>Use Case:</b> {viewAgent.useCase}
            </div>
            <div className="mb-2">
              <b>Tags:</b> {viewAgent.tags && viewAgent.tags.join(", ")}
            </div>
            <div className="mb-2">
              <b>Created By:</b> {viewAgent.createdBy}
            </div>
            <div className="mb-2">
              <b>Client:</b> {viewAgent.clientName}
            </div>
            <div className="mb-2">
              <b>Status:</b> {viewAgent.status}
            </div>
            <div className="mb-2">
              <b>Version:</b> {viewAgent.version}
            </div>
            <div className="mb-2">
              <b>Source:</b> {viewAgent.source}
            </div>
            <div className="mb-2">
              <b>Last Modified:</b>{" "}
              {viewAgent.lastModified
                ? new Date(viewAgent.lastModified).toLocaleString()
                : ""}
            </div>
            {/* Show more details from details API if available */}
            {viewAgent.details && (
              <pre className="bg-gray-100 rounded p-2 text-xs overflow-x-auto mt-2 max-h-60">
                {JSON.stringify(viewAgent.details, null, 2)}
              </pre>
            )}
          </div>
        </div>
