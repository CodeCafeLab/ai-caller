...
const initialLiveCalls: LiveCall[] = [
  {
    id: "call_1",
    callerId: "555-0101",
    campaignName: "Q4 Lead Gen",
    clientName: "Innovate Corp",
    status: "Answered",
    durationSeconds: 125,
    agent: "AI-Agent-01",
    transcriptionSnippet: "Hello, I'm calling about...",
  },
  {
    id: "call_2",
    callerId: "555-0102",
  ...
  },
  {
    ...
    durationSeconds: 310,
    agent: "AI-Agent-02",
    transcriptionSnippet: "Could you tell me more about...",
  },
  {
    id: "call_4",
    callerId: "555-0104",
    ...
    status: "Completed",
    durationSeconds: 65,
    transcriptionSnippet: "Your appointment is confirmed.",
  },
  {
    id: "call_5",
    callerId: "555-0105",
    ...
    status: "Failed",
    durationSeconds: 30,
    transcriptionSnippet: "No answer.",
  },
];
...
const initialLogEntries: LogEntry[] = [
  ...
  },
  {
    ...
    message: "Campaign 'Q4 Lead Gen' started for Innovate Corp.",
    type: "info",
  },
  {
    id: "log_3",
    timestamp: new Date(Date.now() - 5000),
    message: "AI-Agent-01 connected to call 555-0101.",
    type: "info",
  },
];
...
export default function MonitorLiveCallsPage() {
  ...
  const [selectedCallForFlag, setSelectedCallForFlag] =
    React.useState<LiveCall | null>(null);
  ...
  const fetchLiveCallsData = React.useCallback(async () => {
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to fetch live calls data"
      );
  ...
  const handleSubmitFlagMisuse = async () => {
    if (!selectedCallForFlag || !flagReason || !flagDescription.trim()) {
      toast({
        ...
        description:
          "Please select a reason and provide a description for flagging this call.",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleViewConversation = async (call: LiveCall) => {
    ...
    try {
      ...
      const detailsRes = await elevenLabsApi.getConversationDetails(
        call.conversationId
      );
      ...
      try {
        const audioRes = await elevenLabsApi.getConversationAudio(
          call.conversationId
        );
        if (audioRes.ok) {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Real-time insights into your calling operations.
          </p>
        </div>
        <Button
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Human or AI agents currently on calls
            </p>
          </CardContent>
        </Card>
        <Card>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Ongoing and recently completed calls.
            </CardDescription>
          </CardHeader>
                      ...
                      >
                        <div className="flex flex-col items-center justify-center space-y-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm">
                              Create and start a campaign to see live call data
                            </p>
                          </div>
                        </div>
                      </TableCell>
                      ...
                      return (
                        <TableRow key={call.id}>
                          ...
                          <TableCell
                            ...
                            title={call.transcriptionSnippet}
                          >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Real-time system events and call activities.
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-3">
                {logEntries.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground">
                    ...
                    <p className="text-sm">
                      Activity logs will appear here when campaigns are running
                    </p>
                  </div>
                ) : (
                  logEntries.map((log) => {
          ...
          <SheetHeader>
            ...
            <SheetDescription>
              {selectedConversation && (
                <>
                  Call to {selectedConversation.callerId} -{" "}
                    ...
                    <ScrollArea className="flex-1 border rounded-md p-4">
                      <div className="space-y-4">
                        {conversationDetails.transcript ? (
                          <div className="space-y-3">
                            {conversationDetails.transcript.map(
      ...
      <Dialog open={flagMisuseOpen} onOpenChange={setFlagMisuseOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Report inappropriate use of the calling system. This will flag the
              call for review by administrators.
            </DialogDescription>
          </DialogHeader>
            ...
            {selectedCallForFlag && (
              <div className="bg-muted/50 p-3 rounded-md">
                ...
                <p className="text-sm text-muted-foreground">
                  To: {selectedCallForFlag.callerId} | Campaign:{" "}
                  {selectedCallForFlag.campaignName}
                </p>
                <p className="text-sm text-muted-foreground">
                  Agent: {selectedCallForFlag.agent || "Unknown"} | Duration:{" "}
                  {formatDuration(selectedCallForFlag.durationSeconds)}
                </p>
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <Select value={flagReason} onValueChange={setFlagReason}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="privacy-violation">
                    Privacy Violation
                  </SelectItem>
