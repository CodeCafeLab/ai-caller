        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
            ...
            <CardDescription>
              ...
              The agent will be automatically assigned to your account.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
      ...
      <Card className="mt-8">
        ...
        <CardContent className="text-sm text-muted-foreground space-y-2">
          ...
          <p>
            ...
            review and modify basic details like name and category before
            finalizing the import.
          </p>
          <p>
            <strong>Automatic Assignment:</strong> When importing an agent, it
            will be automatically assigned to your account. The imported agent
            will be created in ElevenLabs with your client ID and stored in the
            local database with proper mapping.
          </p>
          <p>
